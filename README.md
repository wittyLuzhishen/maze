...
### 离线运行
项目提供了一个独立的Python工具，可以将游戏打包成单个HTML文件，便于离线使用：
...
2. 在项目根目录下运行：
   ...
   ```
3. 生成的 `maze-game.html` 文件可直接在支持HTML5的浏览器中打开

**工具参数：**
```
python generate_single_html.py -o 自定义名称.html
```
...
- v1.3.0：移除暂停功能，优化游戏流程
- v1.4.0：添加HTML单文件离线版本生成工具
